...
function Titulo(props) {
  ...
  return (
    <>
      ...
      <style jsx>{`
            ${Tag} {
                color: ${appConfig.theme.colors.neutrals['10']};
                font-size: 24px;
                font-weight: 600;
            }
            `}</style>
        ...
        >
          ...
          >
            ...
            <Button
              type='submit'
              label='Entrar'
              disabled={username.length>1?(false):(true)}
              fullWidth
              buttonColors={{
          ...
          >
            <Image
              ...
              src={username.length>1 ? (`https://github.com/${username}.png`):('images/Pika_Correndo.gif')}
            />
            <Text
              variant="body4"
              styleSheet={{
